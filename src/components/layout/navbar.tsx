...
import { Sparkles, Menu, LogOut, User, LayoutDashboard, ChevronDown } from 'lucide-react';
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-56 bg-slate-950 border-slate-800">
                    ...
                    <DropdownMenuItem asChild>
                      <Link href="/settings" className="cursor-pointer text-slate-400 focus:text-white focus:bg-white/5">
                        Settings
                      </Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem 
