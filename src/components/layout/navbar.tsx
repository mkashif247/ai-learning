...
export const Navbar = (): React.JSX.Element => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 h-16 border-b border-white/6bg-[rgba(8,10,15,0.7)] backdrop-blur-2xl backdrop-saturate-150">
              ...
              <div className="flex items-center gap-3">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    ...
                    >
                      <Avatar className="h-8 w-8 border border-white/8]">
                        <AvatarFallback className="bg-white/6text-xs text-white/50">
                  ...
                  <DropdownMenuContent
                    align="end"
                    className="w-56 bg-[#0c0e14border-white/8] backdrop-blur-2xl"
                  >
                    <DropdownMenuLabel>
                    ...
                    <DropdownMenuItem asChild>
                      <Link
                        href="/settings"
                        className="cursor-pointer text-white/50 focus:text-white/90 focus:bg-white/5]"
                      >
                        Settings
                      </Link>
                    </DropdownMenuItem>
