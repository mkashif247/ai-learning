...
export const PracticeModal = ({
  ...
  phaseTitle,
  onClose,
}: PracticeModalProps): React.JSX.Element => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950 flex flex-col animate-in fade-in duration-200">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        />
        <EditorPanel topic={topic} code={code} setCode={setCode} />
      </div>
    </div>
  );
};
        ...
        {question ? (
          <div className="mb-6 bg-slate-900/50 rounded-lg p-4 border border-slate-800">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-medium text-slate-200">Coding Practice</h3>
            </div>
